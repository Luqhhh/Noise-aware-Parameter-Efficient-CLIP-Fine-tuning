"""Cache frozen A2 global features/logits and fixed attention-local features."""
...
from aegis_clip.local_inference import attention_guided_crop, logits_with_last_block_attention
    ...
    *,
    ...
    for batch in loader:
        ...
        with torch.autocast(device_type=device.type, enabled=use_amp):
            global_logits, global_features = model(
                images=images, return_features=True
            )
            ...
            _, local_features = model(images=local_images, return_features=True)
        ...
        parts["global_features"].append(global_features.half().cpu())
        parts["local_features"].append(local_features.half().cpu())
