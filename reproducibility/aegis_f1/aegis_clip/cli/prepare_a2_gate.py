"""Prepare the disjoint A2-to-LoRA selector gate."""
...
from aegis_clip.a2_gate import prepare_a2_gate
...
def main() -> None:
    ...
    parser.add_argument("--aegis-train-csv", required=True)
    parser.add_argument("--aegis-val-csv", required=True)
    ...
    manifest = prepare_a2_gate(
        ...
        aegis_train_csv=args.aegis_train_csv,
        aegis_val_csv=args.aegis_val_csv,
