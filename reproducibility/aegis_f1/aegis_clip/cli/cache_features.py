...
def cache_stage_features(
    ...
    *,
    ...
    """Encode the full current-stage training root into a frozen feature cache."""
    if augmentation != "none" and not output_dir:
    ...
    for images, batch_paths, batch_labels in tqdm(loader, desc="Official CLIP cache"):
        images = apply_feature_augmentation(
            images.to(device, non_blocking=True), augmentation
        )
