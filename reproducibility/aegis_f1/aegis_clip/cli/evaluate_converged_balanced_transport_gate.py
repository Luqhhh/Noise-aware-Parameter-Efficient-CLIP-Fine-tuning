"""Evaluate the frozen V2 converged balanced-prior transport gate."""
...
from aegis_clip.balanced_transport import (
    ...
    V1_TEMPERATURE,
    V2_CHECK_INTERVAL,
    V2_CONVERGENCE_TOLERANCE,
    V2_MAXIMUM_ITERATIONS,
    V2_MINIMUM_ITERATIONS,
...
def _evaluate_cache(
    ...
    *,
    ...
    transport_prediction, sinkhorn = converged_balanced_transport_prediction(
        logits,
        temperature=V1_TEMPERATURE,
        minimum_iterations=V2_MINIMUM_ITERATIONS,
        maximum_iterations=V2_MAXIMUM_ITERATIONS,
        check_interval=V2_CHECK_INTERVAL,
        tolerance=V2_CONVERGENCE_TOLERANCE,
    )
    metric_arguments = {
    ...
    report: dict[str, Any] = {
        ...
        "parameters": {
            "temperature": V1_TEMPERATURE,
            "minimum_sinkhorn_iterations": V2_MINIMUM_ITERATIONS,
            "maximum_sinkhorn_iterations": V2_MAXIMUM_ITERATIONS,
            "convergence_check_interval": V2_CHECK_INTERVAL,
            "convergence_tolerance": V2_CONVERGENCE_TOLERANCE,
...
def evaluate_v2_gate(
    ...
    gate = v2_gate_decision({"f1_m1": f1_report, "a2_m1": a2_report})
    gate.update(
        {
            "test_data_used": False,
            "external_data_used": False,
