...
class TestManifestSchema:
    ...
    def test_all_required_fields_present(self):
        manifest = {
            "experiment_id": "ref",
            "git_commit": "abc123",
            "checkpoint_path": "outputs/baselines/ref/seed42/checkpoints/best.pt",
            "checkpoint_sha256": "sha256...",
            "checkpoint_epoch": 49,
            "split_seed": 42,
            "train_seed": 42,
            "split_dir": "outputs/baselines/ref/seed42",
            "val_csv_sha256": "70a63d5a...",
            "local_micro_accuracy": 0.7065723,
            "local_macro_accuracy": 0.7060997,
            "prediction_csv_path": "outputs/baselines/ref/seed42/submissions/pred_results.csv",
            "prediction_csv_sha256": "79e55629...",
            "zip_internal_csv_sha256": "79e55629...",
            "submission_zip_path": "outputs/baselines/ref/seed42/submissions/submission.zip",
