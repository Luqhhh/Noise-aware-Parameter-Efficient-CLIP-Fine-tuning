...
当前平台最佳：**70.25673889534185%**（17,541/24,967）—— **全微调父模型 +
双 Adapter 基线！**（父模型基线 69.575840% → 70.256739%，+0.6809pp，
+170 正确样本；已突破 70%，距 75% 还有 1,185 正确）
目标：**75%**（需 +1487 正确样本）
...
- 桌面 `submission.zip` = **全微调父模型 + 双 Adapter prior 0.89**
  `fullft_dual_pa0.89`（ZIP sha256 `2da854ec...`）
