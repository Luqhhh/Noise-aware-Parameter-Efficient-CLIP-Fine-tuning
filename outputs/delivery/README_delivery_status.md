...
当前平台最佳：**69.06716866263469%**（17,244/24,967）—— **R3 双 Adapter
prior 0.90！**（BN64+crop112 69.043137% → 69.067169%，+0.0240pp，+6 正确样本）
目标：**75%**（需 +1487 正确样本）
...
- 桌面 `submission.zip` = `r3_dual_adapter_prior_0.92`（ZIP sha256 `f6acaea1...`）
