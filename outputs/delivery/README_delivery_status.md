...
当前平台最佳：**69.57584010894381%**（17,371/24,967）—— **全微调父模型
基线！**（R3 双 Adapter 0.91 69.075179% → 69.575840%，+0.5007pp，
+125 正确样本；距 75% 仅 106 正确）
目标：**75%**（需 +1487 正确样本）
...
- 桌面 `submission.zip` = **全微调父模型 + 双 Adapter 基线**
  `fullft_dual_112_128_144_160_w020_030_040_010_l040_f050_t15_pa085`
  （ZIP sha256 `d99f2b64...`）
