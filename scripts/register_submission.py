...
def main():
    ...
    row = {
        ...
        "split_dir": manifest.get("split_dir", ""),
        "val_csv_sha256": manifest.get("val_csv_sha256", ""),
        ...
        "zip_internal_csv_sha256": manifest.get("zip_internal_csv_sha256", ""),
        ...
        "num_predictions": manifest.get("num_predictions", ""),
