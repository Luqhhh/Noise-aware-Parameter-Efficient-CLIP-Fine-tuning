...
> **当前状态（2026-07-31）**：W060（更多数据 F1）+ M1/Flip + **balanced-prior 校准**（strength 1.0）平台实测 **67.2007%**，新的审计完整平台最佳（prior 0.25→1.0 再 +1.6221pp），ZIP 为 `12e0ec30…5edb`。距离 70 分仅 2.80pp。prior 0.25 包（R1）为 **65.5786%**；无校准 M1/Flip 包为 **63.7802%**。完整结果见 [`results/prior_alignment_20260731.md`](results/prior_alignment_20260731.md) 与 [`results/70p_campaign_20260731.md`](results/70p_campaign_20260731.md)。
...
| 实验 | 平台 | 证据状态 | 说明 |
|------|------:|----------|------|
| **W060 + M1/Flip + balanced-prior 1.0** | **67.2007%** | 已审计（新平台最佳） | 更多数据 F1 + M1/Flip 四视图 + 均衡先验 IPF 校准 |
