...
回归的单 crop176。平台实测 **68.3101694236392%**，比 R2 多尺度最佳
68.32218528457564% 低 **0.012016 个百分点**，未晋级；该差异接近单个测试样本
对应的分数量级，说明更宽教师纠错在平台上基本中性。桌面随后替换为下一双尺度候选。
...
- 桌面副本逐字节一致
- 平台得分：68.3101694236392%
- 相对 R2 多尺度最佳：-0.012016 个百分点
