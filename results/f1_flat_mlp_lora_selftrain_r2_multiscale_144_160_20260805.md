...
不使用本地晋级条件。平台实测 **68.46237032883407%**，比 144/160/176 三尺度
提升 **0.140185 个百分点**，比单 crop160 提升 **0.328434 个百分点**，成为新的
审计完整平台最佳，确认 176 分支对平台有害且 144/160 互补有效。
...
- 桌面副本逐字节一致
- 平台得分：68.46237032883407%
- 相对 144/160/176：+0.140185 个百分点
