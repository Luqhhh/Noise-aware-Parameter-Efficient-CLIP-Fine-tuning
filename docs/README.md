...
| 文档 | 用途 |
|---|---|
| [复赛执行入口](rematch750_execution_20260921.md) | 当前复赛划分、三阶段配置、提交登记与全量重训命令 |
| `../README.md` | 项目入口、当前最佳结果和下一步 |
| [复赛数据集元信息](rematch_dataset_20260921.md) | 2026-09-21 导入的 750 类数据、文件规模、路径、SHA-256 和迁移状态 |
| [初赛大文件清理记录](../results/prelim_storage_cleanup_20260921.md) | 2026-09-21 初赛权重与缓存删除范围、精确清单及本地资产可用性 |
