...
>
> **训练基线**：gce_q07（原 B2_GCE07）单视图 = 58.9578%  
> **提交基线**：gce_q07 + 2-view horizontal-flip TTA = 59.4064%  
> **距 70% 目标**：10.5936pp  
>
> 后续新训练方法应先与单视图 gce_q07 比较；只有训练方法本身有效，才叠加 Flip TTA。
...
- **训练基线**：gce_q07（原 B2_GCE07）单视图，平台 58.9578%——所有新训练方法与此比较
- **提交基线**：gce_q07 + 2-view horizontal-flip TTA，平台 59.4064%——最终提交叠加 TTA
- TTA 收益 +0.45pp 已确认，后续除非 TTA 与新方法冲突，默认叠加
