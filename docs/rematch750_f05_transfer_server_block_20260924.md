# REMATCH750 F05 Evidence-Transfer — Server Block Status (2026-09-24)
...
- ET training had **not started** by the outage cutoff.
- All `ET01–ET10` are marked `server_blocked`.
...
`results/rematch750_f05_transfer/server_block_status_20260924.json`
