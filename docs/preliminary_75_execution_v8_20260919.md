...
状态：**正式队列与平台回填均已完成；B0 平台 67.8816%，比匹配 G0 无 prior 低 1.3458pp；B1 平台 62.0659%，比匹配 L1 无 prior 低 7.2135pp。两候选均为负结果，本轮已关闭并保留 L1 无 prior 69.2794% 为默认非测试拟合路径。协议描述符中的进程地址问题已失败关闭并以严格兼容收据修复；完整记录见 `results/prelim75_v8_execution_20260919.md`。**
