...
head: linear
train_split: outputs/data/d3_strict/seed42/train.csv
val_split: outputs/data/d3_strict/seed42/val.csv
augmentation: a0
batch_size: 128
epochs: 50
...
```
outputs/phase/phase2/d3_logits/
├── val_logits.pt
├── val_labels.pt
├── val_paths.json
├── test_logits.pt
...
```
outputs/phase/phase2/prototype_weights/
├── sample_weights.json
├── sample_weights.csv
...
sample_weighting:
  ...
  weights_path: outputs/phase/phase2/prototype_weights/sample_weights.json
  minimum_weight: 0.2
