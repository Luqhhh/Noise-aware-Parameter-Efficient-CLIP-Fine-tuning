...
本地表格为完全重叠诊断，未作为epoch/参数搜索依据；H0真实平台65.8629%低于匹配无校准P66.7681%，不晋级。其他平台字段留空，75%未认证。H0/H1均低于匹配P，H路线及C已关闭，不追加拟合/扫描；V0/V1平台尚待回填。历史70.352866%及原包保留，新训练不使用旧测试拟合prior，也不将历史校准生产或完整上游谱系认证写作完成。
