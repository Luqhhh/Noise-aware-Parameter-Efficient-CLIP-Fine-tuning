...
本地表格为完全重叠诊断，未作为epoch/参数搜索依据；H0真实平台65.8629%低于匹配无校准P66.7681%，不晋级。其他平台字段留空，75%未认证。C尚未执行，只在真实H/V各至少67.0681%时启动一次。历史70.352866%及原包保留，新训练不使用旧测试拟合prior，也不将历史校准生产或完整上游谱系认证写作完成。
