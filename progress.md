...
## 2026-09-13 PRELIM75_V2独立候选交付完成，H及C关闭，V平台待回填
...
- H0平台真实回填 **65.8629%**，低于匹配无校准P66.7681%共0.9052pp，不晋级。H1平台66.1914%，低于P0.5767pp；H0/H1均未超过P，H及C关闭。V0/V1平台待回填。历史最佳70.352866%保留，不将恢复R1或新本地指标替代历史记录。
