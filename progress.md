...
## 2026-09-13 PRELIM75_V2独立候选交付完成，H及C关闭，暂保留V0，V1平台待回填
...
- H0平台真实回填 **65.8629%**，低于匹配无校准P66.7681%共0.9052pp，不晋级。H1平台66.1914%，低于P0.5767pp；H0/H1均未超过P，H及C关闭。V0平台67.4090%，比同协议P高0.6409pp；距历史70.352866%仍低2.943866pp，暂保留V0。V1平台待回填。历史最佳70.352866%保留，不将恢复R1或新本地指标替代历史记录。
- V1已完成训练/真实诊断/提交，local-only loss对视觉投影和O3/PTA梯度均非零，终态冻结参数不变，batch32未降档。C原门槛未满足，本轮取消；不追加H拟合/扫描。V路线由真实平台分数决定，不用本地重叠诊断替代。
